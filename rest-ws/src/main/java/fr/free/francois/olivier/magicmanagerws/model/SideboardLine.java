 ...
 *
 */
@Entity @Table(name="T_SideboardLine")
...
public class SideboardLine implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private SideboardLineId pk = new SideboardLineId();
	 ...
	 * Constructeur vide
	 */
	public SideboardLine() {}
	
	@EmbeddedId
	public SideboardLineId getPk() {
		return pk;
	}

	public void setPk(SideboardLineId pk) {
		this.pk = pk;
	}

	/**
	 * Retourne la carte de la sideboardLine
	 * 
	 * @return une card
	 */
	@Transient
	...
	/**
	 * Met a jour la carte de la sideboardLine
	 * 
	 * @param card
	 * 			La nouvelle card
	 */
	...
	/**
	 * Retourne le deck de la sideboardLine
	 * 
	 * @return un deck 		
	 */
	@Transient
	...
	/**
	 * Met a jour le deck de la sideboardLine
	 * 
	 * @param deck
	 * 			Le nouveau deck
	 */
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SideboardLine other = (SideboardLine) obj;
		if (pk == null) {
			if (other.pk != null)
				return false;
