...
public class DeckControllerTest {
    ...
    @Test
    public void checkGetDeckByIdUrl() throws Exception{
    	mockMvc.perform(MockMvcRequestBuilders.get("/api/deck/1"))
              .andExpect(MockMvcResultMatchers.status().isOk());

    }
    
    @Test
    public void checkGetDecksUrl() throws Exception{
       mockMvc.perform(MockMvcRequestBuilders.get("/api/decks"))
              .andExpect(MockMvcResultMatchers.status().isOk());
    }
